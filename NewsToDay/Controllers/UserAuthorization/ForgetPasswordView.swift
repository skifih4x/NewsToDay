...
class ForgetPasswordView: CustomView {
    ...
    private lazy var topLabel: UILabel = {
        let element = UILabel()
        element.text = "Reset your password"
    ...
    private lazy var greetingLabel: UILabel = {
        let element = UILabel()
        element.text = "Don't worry. Please enter your email and we will send you a password reset email."
    ...
    private lazy var resetPasswordButton: UIButton = {
        ...
        element.setTitle("Reset", for: .normal)
